...
* Used org.genivi.commonapi.core 3.2.14.v202311100339.
...
public:
     ...
     * will be set.
     */
    virtual void sayHello(std::string _name, uint8_t _index, CommonAPI::CallStatus &_internalCallStatus, std::string &_message, const CommonAPI::CallInfo *_info = nullptr);
    /**
     ...
     */
    virtual std::future<CommonAPI::CallStatus> sayHelloAsync(const std::string &_name, const uint8_t &_index, SayHelloAsyncCallback _callback = nullptr, const CommonAPI::CallInfo *_info = nullptr);
...
template <typename ... _AttributeExtensions>
void HelloWorldProxy<_AttributeExtensions...>::sayHello(std::string _name, uint8_t _index, CommonAPI::CallStatus &_internalCallStatus, std::string &_message, const CommonAPI::CallInfo *_info) {
    delegate_->sayHello(_name, _index, _internalCallStatus, _message, _info);
}

template <typename ... _AttributeExtensions>
std::future<CommonAPI::CallStatus> HelloWorldProxy<_AttributeExtensions...>::sayHelloAsync(const std::string &_name, const uint8_t &_index, SayHelloAsyncCallback _callback, const CommonAPI::CallInfo *_info) {
    return delegate_->sayHelloAsync(_name, _index, _callback, _info);
}
