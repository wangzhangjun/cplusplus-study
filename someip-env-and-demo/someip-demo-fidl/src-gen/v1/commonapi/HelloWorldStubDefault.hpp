...
public:
    ...
    COMMONAPI_EXPORT virtual void sayHello(const std::shared_ptr<CommonAPI::ClientId> _client, std::string _name, uint64_t _index, HelloWorld::EventType _eventType, sayHelloReply_t _reply) {
        (void)_client;
        (void)_name;
        (void)_index;
        (void)_eventType;
    ...
    COMMONAPI_EXPORT virtual void sayGoodBye(const std::shared_ptr<CommonAPI::ClientId> _client, std::string _name, uint64_t _index, HelloWorld::EventType _eventType, sayGoodByeReply_t _reply) {
        (void)_client;
        (void)_name;
        (void)_index;
        (void)_eventType;
    ...
    COMMONAPI_EXPORT virtual void fireMyStatusEvent(const int32_t &_myCurrentValue) {
        HelloWorldStub::fireMyStatusEvent(_myCurrentValue);
    }
    COMMONAPI_EXPORT virtual void myByteBuffer(const std::shared_ptr<CommonAPI::ClientId> _client, CommonAPI::ByteBuffer _indata, myByteBufferReply_t _reply) {
        (void)_client;
        (void)_indata;
