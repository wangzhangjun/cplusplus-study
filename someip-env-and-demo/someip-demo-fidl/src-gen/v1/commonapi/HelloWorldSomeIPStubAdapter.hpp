...
public:
    ...
    CommonAPI::SomeIP::MethodWithReplyStubDispatcher<
        ::v1::commonapi::HelloWorldStub,
        std::tuple< std::string, uint64_t, HelloWorld::EventType>,
        std::tuple< std::string>,
        std::tuple< CommonAPI::SomeIP::StringDeployment, CommonAPI::SomeIP::IntegerDeployment<uint64_t>, ::v1::commonapi::HelloWorld_::EventTypeDeployment_t>,
...
void HelloWorldSomeIPStubAdapterInternal<_Stub, _Stubs...>::fireMyStatusEvent(const int32_t &_myCurrentValue) {
