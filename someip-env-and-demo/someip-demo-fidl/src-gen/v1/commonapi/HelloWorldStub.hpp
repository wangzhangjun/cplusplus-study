...
public:
    ...
    virtual void sayHello(const std::shared_ptr<CommonAPI::ClientId> _client, std::string _name, uint64_t _index, HelloWorld::EventType _eventType, sayHelloReply_t _reply) = 0;
    /// This is the method that will be called on remote calls on the method sayGoodBye.
    virtual void sayGoodBye(const std::shared_ptr<CommonAPI::ClientId> _client, std::string _name, uint64_t _index, HelloWorld::EventType _eventType, sayGoodByeReply_t _reply) = 0;
    ...
    typedef ::v1::commonapi::HelloWorld StubInterface;
};
